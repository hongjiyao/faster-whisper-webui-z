...
def install_dependencies():
    cmd="python -m pip install -r requirements.txt --upgrade -i https://pypi.tuna.tsinghua.edu.cn/simple/"
    subprocess.run(cmd,shell=True, capture_output=False, env=None)
    cmd="pip3 install torch torchaudio --index-url https://download.pytorch.org/whl/cu118"
    subprocess.run(cmd,shell=True, capture_output=False, env=None)
